...
function Hero() {
  return (
    <section className="w-full m-auto py-9">
      <h1 className="text-5xl font-extrabold text-gray-900 leading-tight drop-shadow-lg text-center">
        🎉 Welcome to <span className="text-yellow-500">PokéCart!</span>
      </h1>

      <div className="relative flex flex-col lg:flex-row items-center justify-between max-w-6xl mx-auto mt-10 px-6">
        {/* Text Content */}
        <div className="flex-1 max-w-md lg:max-w-lg text-center lg:text-left lg:ml-12">
